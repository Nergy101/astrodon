...
class PerformanceBenchmark {
    ...
    async runTest(test: PerformanceTest, iterations: number = 3): Promise<number[]> {
        const times: number[] = [];
    ...
    printResults() {
        ...
        console.log('Test Name'.padEnd(30) + 'Avg (ms)'.padEnd(12) + 'Min (ms)'.padEnd(12) + 'Max (ms)'.padEnd(12));
